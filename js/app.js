define("dist/js/app", ["./zepto", "./touch", "./global", "./page", "./media", "./image", "./event", "./sileFn", 
		"./map", "./ylMap", "./form", "./plugins", "./ylMusic", "./fx", "./Lottery", "./video"], 
	...
	require("./image"), require("./event"), require("./plugins"), module.exports = {
		init_modle: function() {
			...
			$(window).on("load", function() {
				...
				}, a), $('.bigTxt-btn a[href^="http://mp.weixin.qq.com"]').on("click", function() {
	...
	var b = a("dist/js/zepto"),
		...
		d = {
			lazy_img: function() {
				...
				a.each(function() {
					var a = b(this);
					if (a.is("img")) a.attr("src", host+"/template/20/res/img/loading_large.gif");
					else {
						...
						a.attr({
							...
							"background-image": "url("+host+"/template/20/res/img/loading_large.gif)",
		...
		g = {
			init: function() {
				...
				b("#coffee_flow").coffee({
					steams: ["<img src='"+host+"/template/19/img/audio_widget_01@2x.png' />", "<img src='"+host+"/template/19/img/audio_widget_01@2x.png' />"],
					steamHeight: 100,
					steamWidth: 44
				...
				if (1 == a) {
					var c = b("#j-mengban")[0],
						d = host+"/template/19/img/page_01_bg@2x.jpg",
						h = b("#r-cover").val(),
						i = "image",
						j = 640,
						k = b(window).height(),
